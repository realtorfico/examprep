...
var NOTARY_FINES_TABLE = {
  headers: ['Violation Type', 'Legal Reference', 'Administrative Sanction', 'Civil Penalty Amount', 'Criminal Classification', 'Grounds for Discipline'],
  rows: [
    ['Willfully stating as true any material fact known to be false in a certificate of acknowledgment', 'Civil Code section 1189(a)(4)', 'Revocation or suspension of commission', 'Up to $10,000', 'Misdemeanor or Felony', 'Execution of a certificate containing a statement known to be false'],
    ['Failure to obtain satisfactory evidence for the identity of a credible witness', 'Civil Code section 1185(b)(1)(B)', 'Revocation or suspension of commission', 'Up to $10,000', 'Not in source', 'Failure to discharge fully and faithfully the duties of a notary public'],
    ['Willful failure to provide access to the sequential journal upon request by a peace officer', 'Government Code section 8214.21', 'Revocation or suspension of commission', 'Up to $2,500', 'Not in source', 'Willful failure to provide access to journal'],
    ['Failure to obtain required thumbprint in the sequential journal', 'Government Code section 8214.23', 'Not in source', 'Up to $2,500', 'Not in source', 'Failure to discharge fully and faithfully the duties of a notary public'],
    ['Illegal advertising in a foreign language or literal translation of "notary public" (non-attorney)', 'Government Code section 8219.5', 'Suspension for at least one year (1st offense); Permanent revocation (2nd offense)', 'Up to $1,500', 'Not in source', 'Violation of Section 8219.5; false or misleading advertising'],
    ['Charging more than the fees prescribed by law', 'Government Code section 8214.1(h)', 'Revocation or suspension of commission', 'Up to $750', 'Not in source', 'Charging more than fees prescribed'],
    ['Failure to complete acknowledgment at the time the seal and signature are affixed', 'Government Code section 8214.1(j)', 'Revocation or suspension of commission', 'Up to $750', 'Not in source', 'Failure to complete acknowledgment at the time of the act'],
    ['Failure to administer the oath or affirmation as required by law', 'Government Code section 8214.1(k)', 'Revocation or suspension of commission', 'Up to $750', 'Not in source', 'Failure to administer oath or affirmation'],
    ['Willful failure to notify the Secretary of State of a change of address', 'Government Code section 8213.5', 'Not in source', 'Up to $500', 'Infraction', 'Willful failure to notify of change of address'],
    ['Willful failure to notify the Secretary of State of a name change', 'Government Code section 8213.6', 'Not in source', 'Up to $500', 'Infraction', 'Willful failure to notify of name change'],
    ['Fraud relating to a deed of trust on a single-family residence', 'Government Code section 8214.2', 'Revocation of commission', 'Not in source', 'Felony', 'Knowing and willful intent to defraud'],
    ['Willful failure to deliver notarial records to the county clerk within 30 days of commission end', 'Government Code section 8209', 'Personal liability for damages', 'Not in source', 'Misdemeanor', 'Willful failure or refusal to deliver records'],
    ['Willful failure to keep the seal under direct and exclusive control', 'Government Code section 8228.1', 'Revocation or suspension of commission', 'Not in source', 'Misdemeanor', 'Failure to secure official seal'],
  ],
